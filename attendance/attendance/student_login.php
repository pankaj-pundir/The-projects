...
//see the difference  in `` and '' as table entry details should have `` and user defined details under ''
  ...
  $sql= "SELECT * FROM `attendence`.`student_login` WHERE `student_id`='$user' AND `password`='$pass' ; ";
...
<div class ="jumbotron" style=" padding: 5%; margin-left:10%; margin-right: 10%; background-color:rgba(100,100,200,0.4); font-family:algerian; font-weight: bold ;font-size:150%;">
...
<center>
	<span class="heading">Username</span> <input style="width: 50%;" class=" form-control" type="text" name="user_name" required="True"><br>
	<span class="heading">Password</span><input style="width: 50%;" class=" form-control" type="password" name="password" required="True"><br> <br>
	<button class="btn btn-success" type="submit" >CHECK IN</button><br><br>
